...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        blogPostId = blog_list.get(position).BlogPostId;
        Log.i("Info","blogcurrentis" + blogPostId);

        String desc_data = blog_list.get(position).getDesc();
        Log.i("Info","descdata"  + desc_data);
        ...
        if (image_url != null){
            ...
            Log.i("Info","imageurl"  + image_url);
        }else {
            Log.i("Info","noimageurl");
        }

        user_id = blog_list.get(position).getUser_id();
        CommentsActivity.posterid = user_id;
        ...
        firebaseFirestore.collection("Users").document(user_id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    holder.setUserData(userName, clearimage);
      ...
      //              Log.i("Info", userName);
        ...
        holder.blogCommentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HomeFragment.setfragment(commentsActivity);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setBlogImage(final String downloadUri){
            ...
            Uri imageUri = Uri.parse(downloadUri);
            ...
            blogImageView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent mathactivity = new Intent(context, imageviewer.class);

                    imageviewer.imageurl = downloadUri;
                    context.startActivity(mathactivity);
                }
            });
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void addlikesnotification() {

        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap.put("Blogpostid",blogPostId);
        hashMap.put("user_id",currentUserId);
        hashMap.put("notificationstype"," liked your post");
        hashMap.put("timestamp", FieldValue.serverTimestamp());
        firebaseFirestore.collection("Users/" + user_id + "/Notifications").add(hashMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
            @Override
            public void onComplete(@NonNull Task<DocumentReference> task) {
                Log.i("Info","taskcompleted");

                if(task.isSuccessful()){
                    Log.i("Info","likeadded");

                } else {

                    Log.i("Info","likefialed");
